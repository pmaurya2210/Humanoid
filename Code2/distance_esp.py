...
def read_esp_responses():
    """Continuously read and print responses from ESP32."""
    while True:
        try:
...
esp_reader_thread = threading.Thread(target=read_esp_responses, daemon=True)
esp_reader_thread.start()
last_trigger_time  = 0
