...
class ListenWindow(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("VIDYA — Listen Mode")
        self.setWindowFlags(
            QtCore.Qt.Window |
    ...
    def _build_ui(self):
        ...
        # top label
        top = QtWidgets.QLabel("◎  VIDYA  —  LISTEN MODE  —  AUDIO PROCESSING")
...
class AuraMain(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("VIDYA — Kotharis")
    ...
    def _make_top_bar(self):
        ...
        aura = QtWidgets.QLabel("VIDYA v1.0")
        aura.setStyleSheet("""
    ...
    def _make_left_info(self):
        ...
        vl.addWidget(card("SYSTEM",    "VIDYA OS"))
    ...
    def _make_right_buttons(self):
        ...
        for b in [self.btn_start, self.btn_train,
                  self.btn_manage, self.btn_sq, self.btn_exit]: #removed stop listening button
            b.setFixedWidth(300)
            vl.addWidget(b)
    ...
    def _make_bottom_bar(self):
        ...
        ver = QtWidgets.QLabel("VIDYA/2.0  ·  KOTHARIS INSTITUTE  ·  AI RECOGNITION SYSTEM")
    ...
    def _run_exit(self):
        ...
        reply = QtWidgets.QMessageBox.question(
            self, "Exit VIDYA", "Exit VIDYA Interface?",
