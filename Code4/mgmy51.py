...
#     _PHASES_RECORDING   = ["TRANSCRIBING"]
#     _PHASES_PROCESSING  = ["THINKING", "TRANSCRIBING"]
#     _PHASES = ["Query Mode Online"]  # default = recording phase

#     def __init__(self, parent=None):
#         super().__init__(parent)
#         self.setWindowTitle("KIKI — Listen Mode")
#         self.setWindowFlags(
#             QtCore.Qt.Window |
...
#         # top label
#         top = QtWidgets.QLabel("◎  KIKI  —  LISTEN MODE  —  AUDIO PROCESSING")
#         top.setAlignment(QtCore.Qt.AlignCenter)
#         top.setStyleSheet("""
#             color: rgba(0,200,255,160); font-family: 'Georgia';
...
#             color: rgba(0,255,180,240); font-family: 'Georgia';
...
#             color: rgba(0,160,220,180); font-family: 'Georgia';
...
#         for rx, ry, rr, rc in [
#             (0.8, 0.15, 0.35, QtGui.QColor(0, -0, 60, 50)),
...
#         p.setFont(QtGui.QFont("Georgia", 9, QtGui.QFont.Bold))
...
#     def __init__(self):
#         super().__init__()
#         self.setWindowTitle("KIKI — Kotharis")
...
#         aura = QtWidgets.QLabel("KIKI v1.0")
#         aura.setStyleSheet("""
#             color: rgba(0,200,255,230); font-family:'Georgia';
...
#             color: rgba(0,230,255,255); font-family:'Georgia';
...
#             color:rgba(0,180,255,180); font-family:'Georgia';
...
#         # ── School logo ───────────────────────────────
#         logo_path = "/home/pradeep/Documents/Humanoid_project/final_humanoid-main/Kothari-International-School-Logo-png-1.png"
#         logo_lbl = QtWidgets.QLabel()
#         logo_lbl.setFixedSize(190, 120)
...
#         else:
#             # Fallback: initials text if file not found
#             logo_lbl.setText("KIS")
#             logo_lbl.setStyleSheet(
#                 "color:rgba(0,210,255,200);font-family:'Georgia';"
#                 "font-size:28px;font-weight:bold;letter-spacing:6px;"
#             )
#         vl.addWidget(logo_lbl, alignment=QtCore.Qt.AlignCenter)
#         # ─────────────────────────────────────────────
...
#             t.setStyleSheet("color:rgba(0,140,200,130);font-family:'Georgia';"
#                             "font-size:9px;letter-spacing:3px;")
#             v = QtWidgets.QLabel(value)
#             v.setStyleSheet(f"color:{vc};font-family:'Georgia';"
...
#         vl.addWidget(card("SYSTEM",    "BOOKWORM OS"))
...
#         hdr.setStyleSheet("color:rgba(0,160,220,110);font-family:'Georgia';"
...
#                   self.btn_manage, self.btn_sq, self.btn_exit]:
#             b.setFixedWidth(300)
#             vl.addWidget(b)
...
#         self.status_lbl.setStyleSheet("""
#             color:rgba(0,200,255,180); font-family:'Georgia';
#             font-size:12px; letter-spacing:3px;""")
#         hl.addWidget(self.status_lbl)
#         hl.addStretch()

#         ver = QtWidgets.QLabel("KIKI/1.0  ·  KOTHARIS INSTITUTE  ·  AI RECOGNITION SYSTEM")
#         ver.setStyleSheet("color:rgba(0,120,180,90);font-family:'Georgia';"
...
#         self.status_lbl.setStyleSheet(f"color:{color};font-family:'Georgia';"
#                                        "font-size:12px;letter-spacing:3px;")
#         max_chars = 90
...
#         self._status("MANAGING DATASET...", "rgba(120,100,255,220)")

#         data_path = os.path.join(os.path.dirname(__file__), "data")
#         os.makedirs(data_path, exist_ok=True)

#         dialog = DatasetFolderDialog(data_path, self)
#         result = dialog.exec_()
...
#             self, "Exit KIKI", "Exit KIKI Interface?",
...
# # ══════════════════════════════════════════════════════
# #  DATASET FOLDER DIALOG
# # ══════════════════════════════════════════════════════
# class DatasetFolderDialog(QtWidgets.QDialog):
#     def __init__(self, path, parent=None):
#         super().__init__(parent)
#         self.setWindowTitle("Manage Dataset")
#         self.setMinimumSize(700, 500)
#         self.path = path

#         layout = QtWidgets.QVBoxLayout(self)
#         layout.addWidget(QtWidgets.QLabel(f"📁 {path}"))
...
#         open_btn = QtWidgets.QPushButton("Open in File Manager")
...
class AuraMain(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self._build_ui()
        self._place_logo()          # ← logo pinned after UI is built
        self.bg.installEventFilter(self)
        self.showMaximized()
    ...
    # ══════════════════════════════════════════════════
    #  LOGO — absolute pixel position, independent of layout
    #  To move UP:   decrease y  (e.g. y=85 → y=60)
    #  To move DOWN: increase y  (e.g. y=85 → y=110)
    #  To move LEFT: decrease x
    # ══════════════════════════════════════════════════
    def _place_logo(self):
        logo_path = "/home/pradeep/Documents/Humanoid_project/final_humanoid-main/Kothari-International-School-Logo-png-1.png"
        self._logo_lbl = QtWidgets.QLabel(self.overlay)
        self._logo_lbl.setFixedSize(240, 150)
        self._logo_lbl.setAlignment(QtCore.Qt.AlignCenter)
        self._logo_lbl.setAttribute(QtCore.Qt.WA_TranslucentBackground)
        if os.path.exists(logo_path):
            pix = QtGui.QPixmap(logo_path).scaled(
                240, 150,
                QtCore.Qt.KeepAspectRatio,
            ...
            self._logo_lbl.setText("KIS")
            self._logo_lbl.setStyleSheet(
                "color:rgba(0,210,255,200);font-family:'Georgia';"
                "font-size:28px;font-weight:bold;letter-spacing:6px;"
            )
        self._logo_lbl.move(30, 130)   # ← change y here to move up/down
        self._logo_lbl.show()
    ...
    def _make_left_info(self):
        ...
        # Logo is placed via _place_logo() at absolute coords on the overlay.
        # This spacing reserves room so the cards don't overlap the logo.
        vl.addSpacing(130)
