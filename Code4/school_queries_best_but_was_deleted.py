...
# ── CONFIGURATION ──────────────────────────────────────────────────────────────
MIC_DEVICE_ID     = None
RECORD_DURATION   = 6          # max recording seconds
SAMPLE_RATE       = 16000
SILENCE_THRESHOLD = 150        # RMS below this = silence
SILENCE_SECONDS   = 0.8        # stop sooner after speech ends (was 1.5s)
...
FACTS = {
    ...
    "how to take admission in kothari school": "Visit entab.online/kispun, or call 8 0 1 0 4 5 8 4 5 8, or email admission@kispune.com.",
    ...
    "what is taught in grade 1":           "Grade 1 to 3 covers English, Hindi, Mathematics, Environmental Studies and Computer Literacy, with focus on Reading, Writing, Arithmetic and Discovery.",
    "what is taught in grade 2":           "Grade 1 to 3 covers English, Hindi, Mathematics, Environmental Studies and Computer Literacy, with focus on Reading, Writing, Arithmetic and Discovery.",
    "what is taught in grade 3":           "Grade 1 to 3 covers English, Hindi, Mathematics, Environmental Studies and Computer Literacy, with focus on Reading, Writing, Arithmetic and Discovery.",
...
whisper_model = whisper.load_model("tiny")   # 4x faster than base, fine for short queries
...
def transcribe(audio_path):
    ...
    result = whisper_model.transcribe(
        ...
        best_of=1,          # no sampling, just 1 pass
        temperature=0.0,    # deterministic = faster
        fp16=False,         # Pi/CPU doesn't support fp16
        condition_on_previous_text=False,  # skip context window overhead
    )
...
def main():
    ...
    # Install hint if smart libs missing
    ...
    while True:
        try:
            ...
            sd.stop()   # stop any ongoing audio
            print("\n[Stopped by user]", flush=True)
            break       # exit cleanly — no speak() call here
        except Exception as e:
